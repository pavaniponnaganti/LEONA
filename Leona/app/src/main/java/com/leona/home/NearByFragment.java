...
import com.leona.registration.ForgotPassword;
 ...
 */
public class NearByFragment extends Fragment implements AsyncHttpResponse.AsyncHttpResponseListener {
    ...
    public void initData(View view){
        ...
        adapter = new NearbyAdapter(this, arrayList, getActivity());
    ...
    private void getRestarunts(int min, int max, boolean status) {
        ...
        Log.e(TAG, "getRestarunts: "+PlayLocation.playlat);
        ...
        AsyncHttpResponse asyncHttpResponse = new AsyncHttpResponse(NearByFragment.this, true);

        asyncHttpResponse.postAsyncHttp(RestApis.nearBy, params, session.getStringData(AppStrings.Responsedata.token),status);
