...
import com.leona.home.Notifications;
import com.leona.utils.AppStrings;
import com.leona.utils.NotificationUtils;
...
public class MyFirebaseMessagingService extends FirebaseMessagingService {
    ...
    private void handleNotification(String message) {
        if (!NotificationUtils.isAppIsInBackground(getApplicationContext())) {
            ...
            Intent pushNotification = new Intent(AppStrings.conFig.PUSH_NOTIFICATION);
    ...
    private void handleDataMessage(JSONObject json) {
        ...
        try {
            ...
            String timestamp = data.getJSONObject("message").getString("dateTime");
