...
public class FavAdapter extends RecyclerView.Adapter<FavAdapter.HomeFolder> {
    ...
    public FavAdapter(ArrayList<HomeModel> arrayList, Activity activity) {
    ...
    @Override
    public FavAdapter.HomeFolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = View.inflate(activity, R.layout.row_list_fav, null);
    ...
    @Override
    public void onBindViewHolder(final FavAdapter.HomeFolder holder, int position) {
        ...
        params = holder.row_home__content_rl.getLayoutParams();
        params.height =    d.getHeight() / 4;
        params.width =   d.getWidth() ;
